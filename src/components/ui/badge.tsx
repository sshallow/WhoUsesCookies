    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          warning: "border-transparent bg-yellow-500 text-slate-900 shadow hover:bg-yellow-500/80 dark:bg-yellow-600 dark:text-slate-50 dark:hover:bg-yellow-600/80", // Add warning variant styles
